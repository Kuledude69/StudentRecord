...
public class StudentRecordTester
{
    public static void main(String[] args)
    {
        ...
        System.out.println(students[0].average(0,a.length-1));
        System.out.println(students[1].average(0,b.length-1));
        System.out.println(students[2].average(0,c.length-1));
    }
